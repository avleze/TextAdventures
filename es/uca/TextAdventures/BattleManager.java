...
public class BattleManager{
    ...
    public void run(OutputManager out, InputManager in, Set<BattleAction> playerActions, PlayerCharacter player, Enemy enemy) { //PlayerCharacter Player, Enemy enemy) {
        ...
        while (player.isAlive() && enemy.isAlive() && player.isOnBattle()) {
            ...
            out.showBattleActions(playerActions);
